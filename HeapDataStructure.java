...
class MinHeap {
    ...
    boolean deleteById(int id) {
        ...
        Node temp = heap.get(indexToDelete);
        heap.set(indexToDelete, heap.get(lastIndex));
...
public class HeapDataStructure {
    ...
    void hapusDariMinHeap(int id) {
        if (minHeap.deleteById(id)) {
            maxHeap.deleteById(id);  // Hapus juga dari max-heap biar konsisten
            System.out.println("✓ Data ID " + id + " berhasil dihapus dari Min-Heap & Max-Heap");
        } else {
    ...
    void hapusDariMaxHeap(int id) {
        if (maxHeap.deleteById(id)) {
            minHeap.deleteById(id);  // Hapus juga dari min-heap biar konsisten
            System.out.println("✓ Data ID " + id + " berhasil dihapus dari Max-Heap & Min-Heap");
        } else {
            System.out.println("✗ Data ID " + id + " tidak ditemukan");
        }
    }
