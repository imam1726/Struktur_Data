...
public class InfiniteCircularDoublyLinkedList {
    ...
    static void tampilForward() throws Exception {
        if (head == null) {
    ...
    static void tampilBackward() throws Exception {
        if (head == null) {
            System.out.println("Tidak ada berita");
            return;
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        do {
            ...
            System.out.println("3. Tampilkan berita secara forward (loop terus)");
            System.out.println("4. Tampilkan berita secara backward (loop terus)");
