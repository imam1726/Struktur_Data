class Matrix:
    ...
    def run(self):
        while True:
            ...
            if choice == "1-a":
                self.matrix = self.sort_row_wise(self.matrix)
                print("\nResult Matrix:")
                self.print_matrix(self.matrix)
            elif choice == "1-b":
                self.matrix = self.sort_column_wise(self.matrix)
                print("\nResult Matrix:")
                self.print_matrix(self.matrix)
            elif choice == "2-a":
                self.matrix = self.rotate_clockwise_by_1(self.matrix)
                print("\nResult Matrix:")
                self.print_matrix(self.matrix)
            elif choice == "2-b":
                self.matrix = self.rotate_counter_clockwise_by_1(self.matrix)
                print("\nResult Matrix:")
                self.print_matrix(self.matrix)
            elif choice == "2-c":
                self.matrix = self.rotate_by_90(self.matrix)
                print("\nResult Matrix:")
                self.print_matrix(self.matrix)
            elif choice == "2-d":
                self.matrix = self.rotate_by_180(self.matrix)
                print("\nResult Matrix:")
                self.print_matrix(self.matrix)
            elif choice == "3-a":
                self.row_wise_traversal(self.matrix)
            elif choice == "3-b":
                self.column_wise_traversal(self.matrix)
            elif choice == "4":
                self.print_spiral_form(self.matrix)
            elif choice == "5":
