...
public class MatrixPreserve {
    private static Scanner scanner = new Scanner(System.in);
    private static int[][] originalMatrix = null;
    ...
    public static void main(String[] args) {
        while (true) {
            ...
            int[][] workingMatrix = copyMatrix(originalMatrix);
            ...
            switch (choice) {
                case "1-a":
                    sortRowWise(workingMatrix);
                    System.out.println("\nResult Matrix:");
                    printMatrix(workingMatrix);
                    break;
                case "1-b":
                    sortColumnWise(workingMatrix);
                    System.out.println("\nResult Matrix:");
                    printMatrix(workingMatrix);
                    break;
                case "2-a":
                    rotateClockwiseBy1(workingMatrix);
                    System.out.println("\nResult Matrix:");
                    printMatrix(workingMatrix);
                    break;
                case "2-b":
                    rotateCounterClockwiseBy1(workingMatrix);
                    System.out.println("\nResult Matrix:");
                    printMatrix(workingMatrix);
                    break;
                case "2-c":
                    workingMatrix = rotateBy90(workingMatrix);
                    System.out.println("\nResult Matrix:");
                    printMatrix(workingMatrix);
                    break;
                case "2-d":
                    workingMatrix = rotateBy180(workingMatrix);
                    System.out.println("\nResult Matrix:");
                    printMatrix(workingMatrix);
                    break;
                case "3-a":
                    rowWiseTraversal(workingMatrix);
                    break;
                case "3-b":
                    columnWiseTraversal(workingMatrix);
                    break;
                case "4":
                    printSpiralForm(workingMatrix);
                    break;
                case "5":
                    workingMatrix = transposeMatrix(workingMatrix);
                    System.out.println("\nResult Matrix:");
                    printMatrix(workingMatrix);
                    break;
                default:
    ...
    private static void inputMatrix() {
        ...
        for (int i = 0; i < rows; i++) {
            ...
            for (int j = 0; j < cols; j++) {
                originalMatrix[i][j] = Integer.parseInt(numbers[j]);
            }
        }
    }
